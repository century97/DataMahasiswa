...
public class MahasiswaController {
    ...
    public void show(){
        ...
        this.mahasiswaView.getNama().setText(String.valueOf(this.mahasiswaView.getTable().getValueAt(index, 0)));
        this.mahasiswaView.getKelas().setText(String.valueOf(this.mahasiswaView.getTable().getValueAt(index, 0)));
        this.mahasiswaView.getAlamat().setText(String.valueOf(this.mahasiswaView.getTable().getValueAt(index, 0)));
    }
    public void clear(){
